/**
 * gitea_repo_analytics: read-only repository statistics — open/closed,
...
export async function buildAnalytics(args = {}, deps = {}) {
  ...
  return {
    ...
    data: {
      ...
      notes: closedTimes.length ? `average cycle time across ${closedTimes.length} closed issues` : 'no closed issues',
    },
  }
}
