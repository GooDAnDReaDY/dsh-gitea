...
export class GiteaClient {
  ...
  listIssues(owner, repo, query = {}) {
    return this.request('GET', `/repos/${owner}/${repo}/issues`, { query })
  }
  ...
  closeIssue(owner, repo, number) {
    return this.request('PATCH', `/repos/${owner}/${repo}/issues/${number}`, { body: { state: 'closed' } })
  }
  ...
  listPulls(owner, repo, query = {}) {
    return this.request('GET', `/repos/${owner}/${repo}/pulls`, { query })
  }
  ...
  mergePull(owner, repo, number, body) {
    return this.request('POST', `/repos/${owner}/${repo}/pulls/${number}/merge`, { body })
  }
