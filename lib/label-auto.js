/**
 * Label-driven workflow automation: applies rules to issues according to
 * labels (type/risk/signal) and returns preview of actions. Read-only.
 */
...
export async function applyLabelRules(args = {}, deps = {}) {
  ...
  return {
    ...
    data: {
      ...
      actions,
      dryRun: true,
      note: 'Recommendations only. Application requires approval.',
    },
  }
}
