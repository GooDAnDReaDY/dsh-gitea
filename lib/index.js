...
import { rememberSessionGitDirs, resolveSessionGitDir, sessionIdsFromExec, sessionCwdFromExec, repoCwdFromTool, candidateGitDirsFromExec, candidateGitDirsFromSessionJsonl } from './session-git.js'
...
export function apply(ctx, config) {
  ...
  ctx.effect(() => ctx.webServer.register({
    ...
    handler: async (req, res) => {
      ...
      if (!resolveSessionGitDir({ cwd, sessionId }) && sessionId) {
        await pinGitFromSessionLog(sessionId)
      }
