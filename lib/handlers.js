...
const NO_REPO = new Set(['gitea_repo_search', 'gitea_whoami', 'gitea_issue_search', 'gitea_issue_lint', 'gitea_org_repos', 'gitea_notifications', 'gitea_ci_explain', 'gitea_pr_template_check', ...LOCAL_TOOLS])
